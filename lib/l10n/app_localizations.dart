...
abstract class AppLocalizations {
  ...
  /// No description provided for @detailsHigh.
  ///
  /// In en, this message translates to:
  /// **'High'**
  String get detailsHigh;

  /// No description provided for @detailsLow.
  ///
  /// In en, this message translates to:
  /// **'Low'**
  String get detailsLow;
  ...
  /// No description provided for @detailsPeRatio.
  ///
  /// In en, this message translates to:
  /// **'PE Ratio'**
  String get detailsPeRatio;

  /// No description provided for @detailsDividendYield.
  ///
  /// In en, this message translates to:
  /// **'Dividend Yield'**
  String get detailsDividendYield;

  /// No description provided for @detailsEps.
  ///
  /// In en, this message translates to:
  /// **'EPS'**
  String get detailsEps;
